<?php
	...
	//checks if a session is started, if not redirect to login page
	...
	if (isset($_POST['myusername'], $_POST['mypassword'])) {
		...
		//fetches the user_id username and password from the db where username is euqal to the variable containing what the user inserted inot the form.
	...
	//else tells the user to retry with a different username or password.
	else {
